...
\providecommand*\plmarginyear[1]{%
  \raggedleft\small{\textcolor{lightgray}{#1}}%
}
...
prinfo=false,
linktitles=all,
url=false,%isbn=false,eprint=false%don't print the arxiv eprint info, since I'll assume DOI covers this
]{biblatex}
...
{\list
  {\iffieldequals{year}{\bibyear}
    {}
    {\textcolor{lightgray}{\printfield{year}}%
     \savefield{year}{\bibyear}}}
  {\setlength{\topsep}{0pt}%
   \setlength{\itemsep}{\bibitemsep}%
   \leftmargin\labelwidth%
   \advance\leftmargin1.5\labelsep}}% chktex 41
{\endlist}
{\item}
...
% 1. arXiv DOIs + URLs (the eprint field already links to the paper)
% 2. URLs when a DOI is present (DOI is the persistent link)
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    \map{
      \step[fieldsource=doi, match={10.48550/arXiv}, final]
...
\addbibresource{/Users/v/Library/texmf/bibtex/bib/all-biblatex.bib}
...
% \input{/Users/v/Library/texmf/custom/jbib_links.tex}
...
% \end{longtable}
  ...
  \begin{longtable}[l]{ll}
    Reviewer for:
    &%
    \href{https://aclrollingreview.org/}{ARR}, 2025, 2026;
