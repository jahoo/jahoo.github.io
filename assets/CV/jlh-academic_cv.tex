...
\begin{longtable}{p{1.7cm}|p{15cm}}
  ...
  %   &[Fast-tracked from MA program in 2019]\\
    % \multicolumn{2}{c}{}\\
  \textsc{Fall '23}%
    &Visiting student, \textbf{MIT}, Computational Psycholinguistics Lab.
     PI: Roger Levy\\
    \multicolumn{2}{c}{}\\
  2006--12%
  ...
  \begin{longtable}{p{1.7cm}|p{15cm}}
    ...
    \textsc{2018--}pres.
    &%
    Graduate student member, webmaster, Montréal Computational and Quantitative
  ...
  \begin{longtable}{p{1.7cm}|p{15cm}}
    % \textsc{2020}&%
    %   \textbf{McGill International Graduate Mobility Award}, for research visit with Prof.\ Roger Levy at MIT. \$6k.\\
    %   % Amount: 6000 CAD
    ...
    \textsc{2020}&%
      ...
      % Title:
      %   Towards characterizing compositionality and systematic generalization
      %   for natural language representations
      % Amount: 27000 CAD
