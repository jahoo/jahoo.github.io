...
\begin{longtable}{p{2cm}|p{14.5cm}}
  ...
  % MATH 4480 \uline{Mathematical Logic} course (Prof.\
  % Robert Reed)\\
  % \textsc{Fall 2016} \hfill& \textbf{Brown University}
  % CLPS 1830, \uline{Grammar and Processing of Ellipsis}
  % seminar (Prof. Pauline Jacobson)\\
  % \hfill& \textbf{MIT} 24.902, \uline{Syntax} course
  % (Prof. David Pesetsky)\\
  % \textsc{Fall 2013} \hfill&\textbf{University of
  % Maryland, College Park}'s \uline{Exploring Quantum
  % Physics} | online certificate (Coursera)\\
  % \hfill&\textbf{BerkeleyX} CS191x: \uline{Quantum
  % Mechanics and Quantum Computation} | online
  % certificate (EdX)\\
  % % \textsc{Spring 2003} & \textbf{Framingham State
  % University} 61.110, \uline{Languages of the World}
