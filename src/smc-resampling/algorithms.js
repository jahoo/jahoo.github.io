...
//  Utility functions, resampling algorithms, test function system,
//  and trial runner.
// ================================================================
...
export function searchSorted(cumsum, u) {
...
export function countIndices(indices, n) {
...
export function getTestFnKey() { return testFnKey; }
export function setTestFnKey(v) { testFnKey = v; }

export function getIndicatorK() { return indicatorK; }
export function setIndicatorK(v) { indicatorK = v; }

export function getResidualPhase2() { return residualPhase2; }
export function setResidualPhase2(v) { residualPhase2 = v; }

export const TEST_FNS = {
    position: {
        label: 'f(\u03BEi) = i/N',
 ...
 *
 * @param {Function} method - resampling function (weights => indices)
 * @param {number} K - number of trials
 * @param {number[]} weights - current weight vector
 */
export function runTrials(method, K, weights) {
 ...
 *
 * @param {object} hist - result from runTrials
 * @param {number[]} weights - current weight vector
 */
export function evalEstimators(hist, weights) {
...
export function gaussianKDE(samples, nPoints, lo, hi) {
