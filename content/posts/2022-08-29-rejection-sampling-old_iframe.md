...
::: {.note-callout title="Archived"}
This is the original version of this post, which embedded a pre-rendered
Quarto notebook in an iframe. It is kept for reference. The current version,
rendered natively, is at [Rejection sampling](/posts/rejection-sampling/).
:::
